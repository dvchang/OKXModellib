...
Pod::Spec.new do |s|
  s.name             = 'OKXModellib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of OKXModellib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/1630880/OKXModellib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '1630880' => 'dvchangyuan@gmail.com' }
  s.source           = { :git => 'https://github.com/1630880/OKXModellib.git', :tag => s.version.to_s }
